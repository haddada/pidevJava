...
public class ListOfOffres1 {
   ...
   /* public static void main(final String[] args) {
                        ...
                        switch(returnValue)
                        {
                            ...
                            case 1 :
                                System.out.println("The return value"+returnValue);
                                    ...
                                    try {
                                        //openPleaseWait();
                                        new OneOffre().openListOfOffresFrameagn(id);
                                    } catch (IOException ex) {
                                        Logger.getLogger(ListOfOffres1.class.getName()).log(Level.SEVERE, null, ex);
                                    }
    ...
    static void openListOfOffresFrame() throws IOException {
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    f3.add(createListOfOffresPanel());
                    f.add(f3);
                } catch (IOException ex) {
                    Logger.getLogger(ListOfOffres1.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    static void openListOfOffresFrameagn() throws IOException {
       ...
       final WebPanel fpanel = new WebPanel();
        new SwingWorker<Void, Void>() {
            @Override
            protected Void doInBackground() throws Exception {
           ...
           // do some processing here while the progress bar is running
                try {
                    ...
                    fpanel.removeAll();
                    fpanel.add(createListOfOffresPanel());
