...
public class ClientListPanel extends WebPanel {
    ...
    private void initComponents() {
        ...
        jTextField1.setInputPrompt("Recherche nom");
        ...
        jButton.setFont(new java.awt.Font("Calibri", 1, 14));
        jButton.setText("Supprimer");
        jButton.setIcon(LoadIcon.loadIcon(getClass().getResource("/images/delete.png")));
