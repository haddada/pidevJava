...
public class Agence_Panel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bt_chercherG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/search.png"))); // NOI18N
        ...
        bt_chercherA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/search.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(bt_trie, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(bt_chercherG, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_chercherG)
                            .addComponent(combo_trie, 0, 104, Short.MAX_VALUE))
    ...
    private void bt_supprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_supprimerActionPerformed
        if (table_agences.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(bt_supprimer, "Veulliez selectionner une agence");
        } else {
    ...
    private void bt_modifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_modifierActionPerformed
        if ((!txt_nom.getText().isEmpty()) && (!txt_description.getText().isEmpty()) && id_ag != 0) {
            ...
            JOptionPane.showMessageDialog(bt_modifier, "Veulliez selectionner une agence à modifier !");
        }
    ...
    private void bt_ajouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_ajouterActionPerformed
        if (txt_nom.getText().isEmpty() || txt_description.getText().isEmpty()) {
            JOptionPane.showMessageDialog(bt_modifier, "Veulliez remplir le nom & l'adresse ");
        } else {
